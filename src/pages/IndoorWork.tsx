...
function IndoorWork() {
  useEffect(() => {
    document.title = 'Sisätyöt - Chore Aid';
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-xl sm:text-2xl text-primary-100 max-w-3xl mx-auto">
              Autamme kotitöissä, siivouksessa ja muissa sisätilojen tehtävissä
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          <div className="mb-16">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <img
                src={indoorWorkImg}
                alt="Opiskelijat tekemässä sisätöitä"
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Mitä sisätyöt sisältävät?
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Autamme monenlaisissa kotitöissä sisätiloissa. Opiskelijamme ovat valmiita auttamaan sinua päivittäisissä askareissa.
              </p>
              <ul className="space-y-4">
                {[
                  { icon: '🧹', title: 'Siivous', desc: 'Yleinen siivous, pölyjen pyyhintä, lattioiden pesu' },
                  { icon: '🛋️', title: 'Imurointi', desc: 'Mattojen ja lattioiden imurointi' },
                  { icon: '🏠', title: 'Kotityöt', desc: 'Erilaiset kodin ylläpitotyöt' },
                  { icon: '🛏️', title: 'Sängyn petaus', desc: 'Vuodevaatteiden vaihto ja järjestely' },
                ].map((item, index) => (
            ...
            <div className="bg-gradient-to-br from-gray-50 to-primary-50 rounded-3xl p-8 sm:p-12">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  Palaa pian takaisin nähdäksesi saatavilla olevat sisätyötehtävät.
                </p>
              </div>
            </div>
          </div>
